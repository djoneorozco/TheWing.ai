...
// ============================================================
// TheWing.ai • Unified Mortgage Engine
// v1.1.0
//
// PURPOSE
// - One canonical mortgage math engine for TheWing.ai and PCSUnited
// - Replaces the need for separate mortgage.js and mortgage-calculator.js
// - Works for:
//   1) Financial Dashboard
//   2) Housing Calculator
//   3) Affordability scoring
//   4) Decision Brief
//   5) Ask Amy / Ask Elena future flows
//
// DESIGN
// - NO Supabase dependency
// - NO OpenAI dependency
// - Deterministic mortgage math only
// - ES Module syntax for TheWing repo with "type": "module"
//
// ROUTES
...
//
// - Rich public calculator format:
//   mortgage, monthly, totals, summary, meta
// ============================================================
...
const ENGINE_VERSION = "thewing-mortgage-engine-1.1.0";
...
function normalizeRateToFraction(rate) {
  const r = n0(rate);

  if (r <= 0) return 0;

  // User may send 1.2 for 1.2%, or 0.012 for 1.2%.
...
function aprFromCreditScore(score) {
  ...
  // These are planning estimates, not lender quotes.
...
function resolveApr({ creditScore, aprOverride }) {
...
// ============================================================
// //#5) DOWN PAYMENT MODEL
// ============================================================

function normalizeDownPayment({ price, downRaw, downAmountRaw, downPctRaw }) {
...
function normalizeInput(body = {}) {
  ...
  // Property tax can be passed as annual amount or rate.
  ...
  if (propertyTaxAnnualInput > 0) {
    ...
    // Conservative fallback for public calculator continuity.
    propertyTaxAnnual = price * 0.012;
    propertyTaxSource = "fallback_1_2_percent";
  }

  // Insurance can be passed as annual amount or rate.
